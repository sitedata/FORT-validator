...
{
	unsigned long n1min = ((struct asn_range const *) arg1)->min;
	unsigned long n1max = ((struct asn_range const *) arg1)->max;
	unsigned long n2min = ((struct asn_range const *) arg2)->min;
	unsigned long n2max = ((struct asn_range const *) arg2)->max;
